...
async function seedSettings() {
    const recipePrompt = await prisma.setting.upsert({
        ...
        create: {
            key: 'recipe_prompt',
            value: `Вы - специализированный ассистент по анализу рецептов. Ваша задача - анализировать предоставленные рецепты и конвертировать их в структурированный JSON формат со следующими данными.
